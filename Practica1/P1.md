...
* **Configuración de redes:** Para ello, he configurado las MV con una red NAT y una red interna. Además, creé un archivo en /etc/network/interfaces para configurar las redes y sus ip. Los archivos de la 
